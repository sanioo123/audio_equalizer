...
Despues de haber instalado VOICE MEETER & Virtual Audio Device, abriremos el .exe y configura el input con el dispositivo "Voicemeeter AUX Input" y en output "Voicemeeter Input"
...
En la salida de audio de windows seleccionaras "Voicemeeter AUX Input" para enviar todo el audio de la computadora a el AudioEqualizer para que luego sea procesado y enviado al Voicemeeter para que finalmente sea enviado y reproducido por nuestros auriculares o dispositivo de audio..
...
en el programa de Voicemeeter tendras que configurar tu en A1 & A2 tu dispositivo final al que enviara el audio ya procesado, yo lo envie a mis auriculares bluetooth JBL VIBE BUDS. Despues de eso tendras que hacer click derecho debajo de Voicemeeter Input y selecionar
"Show Control Panel..."
...
En el menu de "Show Control Panel" buscara el apartado de opciones "Options" y dejaras marcada la opcion "Enable Loopback Streaming"
...
Finalmente presionaras el boton de start para empezar a recibir y procesar toda la señal y disfrutar de un sonido envolvente potente y claro
